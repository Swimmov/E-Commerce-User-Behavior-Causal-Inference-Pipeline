...
bounce_rate ──→ avg_session_time ──→ cart_items ──→ purchase
     ...
     └──────────────────┴───────────────────────────────┘
                            ...
                            discount_seen
```
<img width="510" height="370" alt="DAG_E-comm_1" src="https://github.com/user-attachments/assets/aef3e5e2-a4f8-44a0-aa6e-68674774f983" />
...
<img width="510" height="410" alt="DAG_E-comm_2_confounder" src="https://github.com/user-attachments/assets/3ebf0f0b-238a-4811-a72d-34dd1827c79a" />
